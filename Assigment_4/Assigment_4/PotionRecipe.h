...
struct PotionRecipe// this will not only work as recipe, but also used as info when imitating actual class(ex. sold-> get price from recipe and deduct, use-> cout effect from this
{
